...
<div class="overflow-x-auto w-5xl mx-auto my-10">
    <table class="min-w-full divide-y-2 divide-gray-200">
        ...
        <tbody class="divide-y divide-gray-200">
            <tr class="*:text-gray-900 *:first:font-medium">
                ...
                <td class="px-3 py-2 whitespace-nowrap">john@email.com</td>
                <td class="px-3 py-2 whitespace-nowrap">user</td>
                <td class="px-3 py-2 whitespace-nowrap"><button data-modal-target="popup-modal"
                        data-modal-toggle="popup-modal"
                        class="bg-red-600 text-white py-1 px-2 rounded cursor-pointer">Delete</button></td>
            </tr>

            <tr class="*:text-gray-900 *:first:font-medium">
                <td class="px-3 py-2 whitespace-nowrap">Jane</td>
                <td class="px-3 py-2 whitespace-nowrap">jane@email.com</td>
                <td class="px-3 py-2 whitespace-nowrap">user</td>
                <td class="px-3 py-2 whitespace-nowrap"><button data-modal-target="popup-modal"
                        data-modal-toggle="popup-modal"
                        class="bg-red-600 text-white py-1 px-2 rounded cursor-pointer">Delete</button></td>
